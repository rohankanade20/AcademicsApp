...
//
//    public BookAdapter2(Context context, List<BookItem> bookItemList) {
...
//                    retrieveAndOpenPdf(clickedItem.getName());
//                }
//            }
//        });
//    }
...
//    }
//
////    private void retrieveAndOpenPdf(final String subject) {
////        // Retrieve the PDF file name based on the selected subject
////        String pdfName = "rohan.pdf"; // Change this to match your Firebase Storage file name
...
public class BookAdapter2 extends RecyclerView.Adapter<BookAdapter2.ViewHolder> {
    ...
    public BookAdapter2(Context context, List<BookItem> bookItemList, Map<String, String> pdfMap) {
        this.context = context;
        this.bookItemList = bookItemList;
        this.pdfMap = pdfMap;
    }
