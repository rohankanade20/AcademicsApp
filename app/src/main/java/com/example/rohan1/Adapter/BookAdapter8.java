...
public class BookAdapter8 extends RecyclerView.Adapter<BookAdapter8.ViewHolder> {
    ...
    public BookAdapter8(Context context, List<BookItem> bookItemList, Map<String, String> pdfMap) {
